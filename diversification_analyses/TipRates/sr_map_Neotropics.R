setwd('/Users/michaelharvey/Documents/research/Tyranni/v2/tree_analyses/summary_stats/sr/maps')
getwd()
...
# I was too lazy to replace all instances of "es" with "sr" in script

# AOSHM

# Get es values
es.table <- read.table("../text_files/sr_AOSHM.txt")
es <- es.table$sr
...
pdf(file="sr_AOSHM_Neotropics.pdf", height=7, width=7)
par(mar=c(1,1,1,5))
...
# Get es values
es.table <- read.table("../text_files/sr_AOSC.txt")
es <- es.table$sr
names(es) <- rownames(es.table)
...
# Using initial projection of range maps
pdf(file="sr_AOSC_Neotropics.pdf", height=7, width=7)
par(mar=c(1,1,1,5))
proj4string(wm) <- "+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"
coastline <- readOGR('/Users/michaelharvey/Documents/research/seabirds/sampling_labwork/map/ne_50m_coastline/ne_50m_coastline.shp')
coastline2 <- spTransform(coastline, CRS("+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"))
...
# Get es values
es.table <- read.table("../text_files/sr_IUCN.txt")
es <- es.table$sr
names(es) <- rownames(es.table)
...
# Using initial projection of range maps
pdf(file="sr_IUCN_Neotropics.pdf", height=7, width=7)
par(mar=c(1,1,1,5))
proj4string(wm) <- "+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"
coastline <- readOGR('/Users/michaelharvey/Documents/research/seabirds/sampling_labwork/map/ne_50m_coastline/ne_50m_coastline.shp')
coastline2 <- spTransform(coastline, CRS("+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"))
...
# Get es values
es.table <- read.table("../text_files/sr_HGAPF_AOSHM.txt")
es <- es.table$sr
names(es) <- rownames(es.table)
...
# Using initial projection of range maps
pdf(file="sr_HGAPF_AOSHM_Neotropics.pdf", height=7, width=7)
par(mar=c(1,1,1,5))
proj4string(wm) <- "+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"
coastline <- readOGR('/Users/michaelharvey/Documents/research/seabirds/sampling_labwork/map/ne_50m_coastline/ne_50m_coastline.shp')
coastline2 <- spTransform(coastline, CRS("+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"))
...
# Get es values
es.table <- read.table("../text_files/sr_Astral_AOSHM.txt")
es <- es.table$sr
names(es) <- rownames(es.table)
...
# Using initial projection of range maps
pdf(file="sr_Astral_AOSHM_Neotropics.pdf", height=7, width=7)
par(mar=c(1,1,1,5))
proj4string(wm) <- "+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"
coastline <- readOGR('/Users/michaelharvey/Documents/research/seabirds/sampling_labwork/map/ne_50m_coastline/ne_50m_coastline.shp')
coastline2 <- spTransform(coastline, CRS("+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"))
...
# Get es values
es.table <- read.table("../text_files/sr_Astral_AOSHM_missingdropped.txt")
es <- es.table$sr
names(es) <- rownames(es.table)
...
# Using initial projection of range maps
pdf(file="sr_Astral_AOSHM_missingdropped_Neotropics.pdf", height=7, width=7)
par(mar=c(1,1,1,5))
proj4string(wm) <- "+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"
coastline <- readOGR('/Users/michaelharvey/Documents/research/seabirds/sampling_labwork/map/ne_50m_coastline/ne_50m_coastline.shp')
coastline2 <- spTransform(coastline, CRS("+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"))
