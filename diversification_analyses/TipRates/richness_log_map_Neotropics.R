setwd('/Users/michaelharvey/Documents/research/Tyranni/v2/tree_analyses/summary_stats/richness')
getwd()
...
# Get es values
es.table <- read.table("../es/text_files/es_AOSHM.txt")
es <- es.table$x
...
# For each species, make raster for richness and another for weights
rich.rasters <- stack()
count.rasters <- stack()
for(i in 1:length(joined)) {
	...
	rich.raster <- r
	count.raster <- r
	rich.raster[joined[i],] <- 1
	count.raster[joined[i],] <- 1/cell.count
	rich.rasters <- stack(rich.rasters, rich.raster)
	count.rasters <- stack(count.rasters, count.raster)
}
#wm <- weighted.mean(x=rich.rasters, w=count.rasters, na.rm=TRUE)
wm <- sum(rich.rasters, na.rm=TRUE)
values(wm)[values(wm) == 0] <- NA
values(wm) <- log(values(wm))
library(RColorBrewer)
Pal <- rev(brewer.pal(n=11, c("RdYlBu")))

# Using initial projection of range maps
pdf(file="log_richness_AOSHM_Neotropics.pdf", height=7, width=7)
par(mar=c(1,1,1,5))
...
mapCountryData(sPDF, nameColumnToPlot="continent", colourPalette=c("white", "white"), addLegend=FALSE, borderCol="white", mapTitle="", xlim=c(-12000000, -2000000), ylim=c(-3000000, 3000000))
...
# Get es values
es.table <- read.table("../es/text_files/es_AOSC.txt")
es <- es.table$x
names(es) <- rownames(es.table)
...
# Using initial projection of range maps
pdf(file="log_richness_AOSC_Neotropics.pdf", height=7, width=7)
par(mar=c(1,1,1,5))
proj4string(wm) <- "+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"
coastline <- readOGR('/Users/michaelharvey/Documents/research/seabirds/sampling_labwork/map/ne_50m_coastline/ne_50m_coastline.shp')
coastline2 <- spTransform(coastline, CRS("+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"))
...
# Get es values
es.table <- read.table("../es/text_files/es_IUCN.txt")
es <- es.table$x
names(es) <- rownames(es.table)
...
# Using initial projection of range maps
pdf(file="log_richness_IUCN_Neotropics.pdf", height=7, width=7)
par(mar=c(1,1,1,5))
proj4string(wm) <- "+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"
coastline <- readOGR('/Users/michaelharvey/Documents/research/seabirds/sampling_labwork/map/ne_50m_coastline/ne_50m_coastline.shp')
coastline2 <- spTransform(coastline, CRS("+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"))
...
# Get es values
es.table <- read.table("../es/text_files/es_HGAPF_AOSHM.txt")
es <- es.table$x
names(es) <- rownames(es.table)
...
# Using initial projection of range maps
pdf(file="log_richness_HGAPF_AOSHM_Neotropics.pdf", height=7, width=7)
par(mar=c(1,1,1,5))
proj4string(wm) <- "+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"
coastline <- readOGR('/Users/michaelharvey/Documents/research/seabirds/sampling_labwork/map/ne_50m_coastline/ne_50m_coastline.shp')
coastline2 <- spTransform(coastline, CRS("+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"))
...
# Get es values
es.table <- read.table("../es/text_files/es_Astral_AOSHM.txt")
es <- es.table$x
names(es) <- rownames(es.table)
...
# Using initial projection of range maps
pdf(file="log_richness_Astral_AOSHM_Neotropics.pdf", height=7, width=7)
par(mar=c(1,1,1,5))
proj4string(wm) <- "+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"
coastline <- readOGR('/Users/michaelharvey/Documents/research/seabirds/sampling_labwork/map/ne_50m_coastline/ne_50m_coastline.shp')
coastline2 <- spTransform(coastline, CRS("+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"))
...
# Get es values
es.table <- read.table("../es/text_files/es_Astral_AOSHM_missingdropped.txt")
es <- es.table$x
names(es) <- rownames(es.table)
...
# Using initial projection of range maps
pdf(file="log_richness_Astral_AOSHM_missingdropped_Neotropics.pdf", height=7, width=7)
par(mar=c(1,1,1,5))
proj4string(wm) <- "+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"
coastline <- readOGR('/Users/michaelharvey/Documents/research/seabirds/sampling_labwork/map/ne_50m_coastline/ne_50m_coastline.shp')
coastline2 <- spTransform(coastline, CRS("+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"))
