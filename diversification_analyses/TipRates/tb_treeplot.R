setwd('/Users/michaelharvey/Documents/research/Tyranni/v2/div_analyses/summary_stats/tb/tree_plot')
getwd()
...
# Get es values
tb.table <- read.table("../text_files/tb_AOSHM.txt")
tb <- tb.table$x
names(tb) <- rownames(tb.table)

# Plot (based on code from Rafael Maia)
bardata <- exp(tb[tree$tip.label]) 
...
# Get es values
tb.table <- read.table("../text_files/tb_AOSC.txt")
tb <- tb.table$x
names(tb) <- rownames(tb.table)
...
# Get es values
tb.table <- read.table("../text_files/tb_IUCN.txt")
tb <- tb.table$x
names(tb) <- rownames(tb.table)
...
# Get es values
tb.table <- read.table("../text_files/tb_1My.txt")
tb <- tb.table$x
names(tb) <- rownames(tb.table)
...
# Get es values
tb.table <- read.table("../text_files/tb_2My.txt")
tb <- tb.table$x
names(tb) <- rownames(tb.table)
...
# Get es values
tb.table <- read.table("../text_files/tb_dupsdropped.txt")
tb <- tb.table$x
names(tb) <- rownames(tb.table)
...
# Get es values
tb.table <- read.table("../text_files/tb_HGAPF_AOSHM.txt")
tb <- tb.table$x
names(tb) <- rownames(tb.table)
...
# Get es values
tb.table <- read.table("../text_files/tb_Astral_AOSHM.txt")
tb <- tb.table$x
names(tb) <- rownames(tb.table)
...
# Get es values
tb.table <- read.table("../text_files/tb_Astral_AOSHM_missingdropped.txt")
tb <- tb.table$x
names(tb) <- rownames(tb.table)
