...
# Fast Intuitive analysis of State-dependent Speciation Extinction rates
#     Modified by M. G. Harvey to take existing diversification summary values as argument
#                  
FISSE.binary.mod <- function(phy, states, dx, reps = 1000, tol=0.1, qratetype = "mk", incomplete = TRUE, ...){
